...
class LocationPermission extends Component {
  render() {
    return (
      <div>
        <div className="container text-center" style={{ height: "860px" }}>
          ...
          <div className="row mb-5">
            ...
            <div className="col-md-7 ml-3 pt-3">
              We would like to request <b>location permissions</b> so that you
              can track your order<br></br> in real-time
            </div>
          ...
          <div className="row mt-5">
            ...
            <div className="col-md-6">
              <button className="btn text-white footer-btn-right">Allow</button>
            </div>
          </div>
        </div>
      </div>
